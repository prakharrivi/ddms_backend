...
var UserdocumentService = require('../../services/document/userdocument_service')
var Constant = require('../../Constant/Constant')

router.post('/documentmail', async function (req, res) {
  UserdocumentService.documentmail(req)
    .then(function (data) {
      if (data) {
...
router.post('/finduserdata', async function (req, res) {
  UserdocumentService.finduserdata(req)
    .then(function (data) {
      if (data) {
        res.status(200).send(data)
      } else {
...
router.post('/getnextleveluser', async function (req, res) {
  UserdocumentService.getnextleveluser(req)
    .then(function (data) {
      if (data) {
        res.status(200).send(data)
      } else {
