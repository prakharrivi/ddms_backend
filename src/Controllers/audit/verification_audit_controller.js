...
var audit_verificationService = require('../../services/audit/verification_audit_service')
var Constant = require('../../Constant/Constant')

router.post('/getverfication', async function (req, res) {
  audit_verificationService
    .getverfication(req)
    .then(function (data) {
      if (data) {
